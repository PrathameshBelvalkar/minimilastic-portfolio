...
} from "@/src/components/assistant-ui/elements/attachment.aui";
import { File } from "@/src/components/assistant-ui/elements/file";
import { ThreadFollowupSuggestions } from "@/src/components/assistant-ui/elements/follow-up-suggestions.aui";
import { Image } from "@/src/components/assistant-ui/elements/image";
import { MarkdownText } from "@/src/components/assistant-ui/elements/markdown-text";
import {
  Reasoning,
  ReasoningContent,
  ReasoningRoot,
  ReasoningText,
  ReasoningTrigger,
} from "@/src/components/assistant-ui/elements/reasoning.aui";
import { ToolFallback } from "@/src/components/assistant-ui/elements/tool-fallback.aui";
import {
  ToolGroupContent,
  ToolGroupRoot,
  ToolGroupTrigger,
} from "@/src/components/assistant-ui/elements/tool-group.aui";
import { TooltipIconButton } from "@/src/components/assistant-ui/elements/tooltip-icon-button";
  ...
  return (
    <ThreadPrimitive.Root
      ...
      style={{
        ...
        ["--composer-bg" as string]: "var(--color-card-bg)",
      ...
      >
        <div
          className={cn(
            ...
            isEmpty && "justify-end pb-2 sm:justify-center sm:pb-0",
          )}
        >
          ...
          <ThreadPrimitive.ViewportFooter
            className={cn(
              "aui-thread-viewport-footer bg-background flex shrink-0 flex-col gap-3 overflow-visible pb-4 md:pb-6",
              !isEmpty &&
...
const ThreadWelcome: FC = () => {
  return (
    <div className="aui-thread-welcome-root mb-6 flex flex-col px-2">
      <p className="aui-thread-welcome-message-inner fade-in slide-in-from-bottom-1 animate-in fill-mode-both text-lg font-medium tracking-tight duration-200">
        Ask about this post
      </p>
    </div>
  );
